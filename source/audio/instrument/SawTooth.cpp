...
namespace audio
{
	...
	{
		SawTooth::SawTooth( unsigned int samplingFrequency, unsigned short int channels ) : Instrument(samplingFrequency, channels)
		{
		}
		...
		Sound * SawTooth::generate( float note, unsigned int duration, float volume )
		{
